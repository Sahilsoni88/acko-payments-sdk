...
import static com.acko.payment.sdk.e2e.support.MockResponses.token;
...
class PayoutRetryPolicyMockE2ETest extends MockE2ETestSupport {
    ...
    void should_retrySafeOperation_whenServerErrorThenSuccess() {
        ...
        assertRequest(requests.get(1), "GET", "/api/payout-123/verify", AUTHORIZATION);
        assertRequest(requests.get(2), "GET", "/api/payout-123/verify", AUTHORIZATION);
    }
    ...
    void should_notRetryInitiate_whenServerError() {
        ...
        assertRequest(requests.get(1), "POST", "/api/v2/initiate_payout", AUTHORIZATION);
    }
